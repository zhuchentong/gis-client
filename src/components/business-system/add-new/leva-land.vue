<template>
  ...
  <el-form :model="model" :rules="rules" label-width="120px" ref="form" inline class="component leva-land">
    ...
    <el-form-item label="征地文号" prop="useInfo">
      <el-input v-model="model.useInfo"></el-input>
    </el-form-item>
    <el-form-item label="征收日期" prop="remark">
      <el-select v-model="model.remark"></el-select>
    </el-form-item>
    <el-form-item label="土地用途" prop="remark">
      <el-input v-model="model.remark"></el-input>
    </el-form-item>
    <el-form-item label="批文编号" prop="remark">
      <el-input v-model="model.remark"></el-input>
    </el-form-item>
