<template>
  <section class="component cost-land">
    <el-form :model="model" label-width="180px" ref="form">
      ...
      <el-form-item label="安置补助费" prop="farmPlacement">
        <el-input v-model="model.farmPlacement" type="number" :min="0" :max="999999">
          <span slot="append">元/人</span>
        </el-input>
        <el-input v-model="model.population" type="number" :min="0" :max="999999">
